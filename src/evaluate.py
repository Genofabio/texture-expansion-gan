...
if __name__ == "__main__":
    model_name = "model_7img_discriminator"
    base_folder = "../data/evaluation/extraset/model_7img_discriminator"
    weights_path = "../data/evaluation/extraset/model_7img_discriminator/weights/Paper7Discriminator.pt"
