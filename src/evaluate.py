...
if __name__ == "__main__":
    model_name = "model_1img_augmented"
    base_folder = "../data/evaluation/intraset/model_1img_augmented"
    weights_path = "../data/evaluation/intraset/model_1img_augmented/weights/Paper1Augmented.pt"
