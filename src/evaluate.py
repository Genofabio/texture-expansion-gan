...
if __name__ == "__main__":
    model_name = "model_7img_augmented"
    base_folder = "../data/evaluation/extraset/model_7img_augmented"
    weights_path = "../data/evaluation/extraset/model_7img_augmented/weights/Paper7Augmented.pt"
